...
import xyz.ummo.user.ui.fragments.delegatedService.dummy.DummyContent
...
class DelegatedServiceFragment2 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_delegatedservice_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyDelegatedServiceRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
